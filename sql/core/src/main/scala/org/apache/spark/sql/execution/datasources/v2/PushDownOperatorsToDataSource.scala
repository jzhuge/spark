...
/**
 * This rule is the DataSourceV2 equivalent of
 * [[org.apache.spark.sql.execution.SparkPlanner.pruneFilterProject]]. Instead of producing nodes
 * for the physical plan, this refines [[DataSourceV2Relation]] logical nodes so that the optimizer
 * can continue applying rules after predicate and projection push-down.
 */
object DataSourceV2PushDown extends Rule[LogicalPlan] {
  override def apply(
