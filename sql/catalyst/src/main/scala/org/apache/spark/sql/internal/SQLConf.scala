...
object SQLConf {
  ...
  val PARQUET_COMPRESSION = buildConf("spark.sql.parquet.compression.codec")
    ...
    .checkValues(Set("none", "uncompressed", "snappy", "gzip", "lzo", "brotli"))
  ...
  val OVERRIDE_MAX_PARTITION_SIZE = buildConf("spark.sql.override.maxPartitionSize")
  ...
  val HIVE_FORCE_SORTED_WRITE =
    buildConf("spark.sql.hive.force-sorted-write")
