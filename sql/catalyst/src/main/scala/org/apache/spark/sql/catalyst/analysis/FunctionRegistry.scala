...
object FunctionRegistry {
  ...
  val expressions: Map[String, (ExpressionInfo, FunctionBuilder)] = Map(
    ...
    expression[CurrentDate]{"nf_date_today"},
    expression[CurrentTimestamp]("nf_timestamp_now"),
    expression[NfDateInt]("nf_dateint"),
    expression[NfDateIntToday]("nf_dateint_today"),
    expression[NfDateString]("nf_datestr"),
    expression[NfDateStringToday]("nf_datestr_today"),
    expression[NfUnixTimeNow]("nf_unixtime_now"),
    expression[NfUnixTimeNowMs]("nf_unixtime_now_ms"),
    expression[NfToUnixTime]("nf_to_unixtime"),
    expression[NfToUnixTimeMs]("nf_to_unixtime_ms"),
    expression[NfFromUnixTime]("nf_from_unixtime"),
    expression[NfFromUnixTimeMs]("nf_from_unixtime_ms"),
    expression[NfFromUnixTimeTz]("nf_from_unixtime_tz"),
    expression[NfFromUnixTimeMsTz]("nf_from_unixtime_ms_tz"),
    expression[NfDate]("nf_date"),
    expression[NfDateToday]("nf_date_today"),
    expression[NfTimestamp]("nf_timestamp"),
    expression[NfTimestampNow]("nf_timestamp_now"),
    expression[NfDateAdd]("nf_dateadd"),
    expression[NfDateDiff]("nf_datediff"),
    expression[NfDateTrunc]("nf_datetrunc"),
    expression[NfDateFormat]("nf_dateformat"),
    expression[NfYear]("nf_year"),
    expression[NfMonth]("nf_month"),
    expression[NfDay]("nf_day"),
    expression[NfHour]("nf_hour"),
    expression[NfMinute]("nf_minute"),
    expression[NfSecond]("nf_second"),
    expression[NfMillisecond]("nf_millisecond"),
