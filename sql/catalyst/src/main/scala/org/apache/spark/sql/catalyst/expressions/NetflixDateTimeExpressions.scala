...
@ExpressionDescription(
  usage = "_FUNC_(input date, timezone) - Converts epoch seconds to timestamp in a given timezone.")
...
@ExpressionDescription(
  usage = "_FUNC_(input) - Extracts millisecond of second as an integer from the input (0 to 999)")
