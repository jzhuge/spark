...
package object config {
  ...
  private[spark] val DRIVER_DEFAULT_JAVA_OPTIONS =
    ConfigBuilder(SparkLauncher.DRIVER_DEFAULT_JAVA_OPTIONS).stringConf.createOptional
  ...
  private[spark] val EXECUTOR_DEFAULT_JAVA_OPTIONS =
    ConfigBuilder(SparkLauncher.EXECUTOR_DEFAULT_JAVA_OPTIONS).stringConf.createOptional
